...
// NewCmdObjectStorage creates the parent object-storage command.
func NewCmdObjectStorage(f cmdutil.Factory, ioStreams cmdutil.IOStreams) *cobra.Command {
	cmd := &cobra.Command{
		Use:     "object-storage",
		Aliases: []string{"oss", "d4"},
